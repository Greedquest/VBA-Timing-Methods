...
That should be enough information to arm anyone with the ability to have a stab at breaking this


# Implementation

That may have been a bit of an excessive intro! But I want to provide some background explaining why this is even a problem, and to give some insight into the thought process behind the design (what's essential, what's just for a friendly API, what may be unnecessary)
